...
namespace Backend.API.DTOs.Requests.CaseRequests
{
    public class UpdateCaseRequest
    {
        ...
        public UpdateCaseRequest(Guid id, string? requirementNumber, DateTime? receptionDate, Guid? originDocumentId, string? physicallyReceived, string? digitallyReceived, 
                ...
                Guid? userId, Guid? typeRequirementId, string? notification, string? subject, DateTime? transferDate, DateTime? deadline, Guid? provinceId, DateTime? dueDate, 
                Guid? reminderId, DateTime? replyDate, string? comments, DateTime? responseDate, Guid? caseStatusId, string? observationDepartment, Guid? caseStatusSecretaryId,
                DateTime? acknowledgmentDate, DateTime? extensionRequestDate, DateTime? newExtensionRequestDate, string? observationExtension)
        {
            Id = id;
        ...
        public UpdateCaseCommand ToApplicationRequest(Guid id)
        {
            return new UpdateCaseCommand(id, RequirementNumber, ReceptionDate, OriginDocumentId, PhysicallyReceived, DigitallyReceived, DocumentNumber, SbsNumber, JudgmentNumber
