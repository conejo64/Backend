    ...
    EntityResponse<byte[]>>
{
    ...
    {
        var spec = new CaseSpec(query.OriginDocumentId, query.CaseStatusId, query.DepartmentId, query.InitialDate, query.FinalDate, query.IsPagingEnabled, 1, Int32.MaxValue);
        //Get entity list
