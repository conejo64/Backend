...
namespace Backend.Application.Queries.CaseQueries
{
        ...
        EntityResponse<GetEntitiesResponse<CaseResponse>>>
    {
        ...
        {
            var spec = new CaseSpec(query.BrandId, query.CaseStatusId, query.DepartmentId, query.InitialDate, query.FinalDate, query.IsPagingEnabled, query.Page, query.PageSize);
