...
public class PermissionSeeder
{
    public static void SeedData(BackendDbContext context)
    {
        ...
        context.Set<Permission>().AddRange(
            ...
            // Catalogs
            new Permission(Guid.Parse("4bcecb40-1b79-48d2-ab09-80499ded70ed"), "Backend:Catalogs:FullAccess", "Acceso total a catálogos", "CATALOGS", PermissionTypes.Global),
            new Permission(Guid.Parse("c66f0f7b-10a0-4a39-a04f-8488259e2171"), "Backend:Catalogs:ReadEditAccess", "Acceso de lectura y edición de catálogos", "CATALOGS", PermissionTypes.Global),
            new Permission(Guid.Parse("f3e1fc5c-d5d3-46e0-bf4d-6ee6b694c564"), "Backend:Catalogs:ReadOnlyAccess", "Acceso de sólo lectura de catálogos", "CATALOGS", PermissionTypes.Global),
            new Permission(Guid.Parse("1fa956bd-fa4f-449b-9dd1-2643b3e622c9"), "Backend:Catalogs:Delete", "Acceso para eliminar catálogos", "CATALOGS", PermissionTypes.Global),
            new Permission(Guid.Parse("25643db5-4007-4e80-a8bc-59d7b96d83de"), "Backend:Catalogs:CreateAccess", "Acceso a la creación de catálogos", "CATALOGS", PermissionTypes.Global),
            // // Materials
